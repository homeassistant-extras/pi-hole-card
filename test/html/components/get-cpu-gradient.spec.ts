...
describe('get-cpu-gradient.ts', () => {
  ...
  describe('getCpuGradient', () => {
    it('should create a gradient for normal line type', () => {
      ...
      const gradient = getCpuGradient(mockCtx, chartArea, 'normal');
    ...
    it('should create a gradient for gradient line type', () => {
      ...
      const gradient = getCpuGradient(mockCtx, chartArea, 'gradient');
    ...
    it('should create a gradient for gradient_no_fill line type', () => {
      ...
      const gradient = getCpuGradient(mockCtx, chartArea, 'gradient_no_fill');
    ...
    it('should use default normal line type when not specified', () => {
      ...
      const gradient = getCpuGradient(mockCtx, chartArea);
    ...
    it('should cache gradient for same dimensions and line type', () => {
      ...
      const gradient1 = getCpuGradient(mockCtx, chartArea, 'normal');
      const gradient2 = getCpuGradient(mockCtx, chartArea, 'normal');
    ...
    it('should create new gradient when chart dimensions change', () => {
      ...
      const gradient1 = getCpuGradient(mockCtx, chartArea1, 'normal');
      const gradient2 = getCpuGradient(mockCtx, chartArea2, 'normal');
    ...
    it('should create new gradient when line type changes', () => {
      ...
      const gradient1 = getCpuGradient(mockCtx, chartArea, 'normal');
      const gradient2 = getCpuGradient(mockCtx, chartArea, 'gradient');
      const gradient3 = getCpuGradient(mockCtx, chartArea, 'gradient_no_fill');
